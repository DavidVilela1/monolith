...
/// <summary>Identity of a <see cref="Agreements.RappelClaim"/>.</summary>
/// <param name="Value">The underlying identifier.</param>
public readonly record struct RappelClaimId(Guid Value)
{
    /// <summary>The unset identifier.</summary>
    public static readonly RappelClaimId Empty = new(Guid.Empty);

    /// <summary>Generates a new identifier.</summary>
    public static RappelClaimId New() => new(OrderedGuid.Create());
