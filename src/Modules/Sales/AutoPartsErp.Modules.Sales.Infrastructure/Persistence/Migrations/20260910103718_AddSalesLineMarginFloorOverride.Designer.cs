...
namespace AutoPartsErp.Modules.Sales.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260910103718_AddSalesLineMarginFloorOverride")]
    partial class AddSalesLineMarginFloorOverride
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoPartsErp.Modules.Sales.Domain.Orders.SalesOrder", b =>
                {
                    ...
                    b.Property<bool>("CreditLimitOverridden")
                        .HasColumnType("boolean")
                        .HasColumnName("credit_limit_overridden");
                    ...
                    b.Property<DateOnly?>("LastInvoicedOn")
                        .HasColumnType("date")
                        .HasColumnName("last_invoiced_on");
                    ...
                    b.HasIndex("TenantId", "Status", "InvoicingStatus")
            ...
            modelBuilder.Entity("AutoPartsErp.Modules.Sales.Domain.Returns.CustomerReturn", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<DateOnly?>("CreditedOn")
                        .HasColumnType("date")
                        .HasColumnName("credited_on");
            ...
            modelBuilder.Entity("AutoPartsErp.Persistence.Numbering.NumberSequence", b =>
                {
                    ...
                    b.ToTable("number_sequences", "sales");
                });
                    ...
                    b.OwnsMany("AutoPartsErp.Modules.Sales.Domain.Orders.SalesOrderLine", "Lines", b1 =>
                        {
                            ...
                            b1.Property<Guid?>("CoreForLineId")
                                .HasColumnType("uuid")
                            ...
                            b1.Property<bool>("MarginFloorOverridden")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                            ...
                            b1.OwnsOne("AutoPartsErp.SharedKernel.ValueObjects.Quantity", "InvoicedQuantity", b2 =>
                                {
                                    b2.Property<Guid>("SalesOrderLineId")
                                        .HasColumnType("uuid")
                                        .HasColumnName("id");
                            ...
                            b1.OwnsOne("AutoPartsErp.SharedKernel.ValueObjects.Quantity", "ReturnedQuantity", b2 =>
                                {
                                    b2.Property<Guid>("SalesOrderLineId")
                                        .HasColumnType("uuid")
                                        .HasColumnName("id");
                                    ...
                                    b2.Property<string>("Unit")
                                        ...
                                        .HasMaxLength(8)
                                        .HasColumnType("character varying(8)")
                                        .HasColumnName("returned_quantity_unit");
                            ...
                            b1.OwnsOne("AutoPartsErp.SharedKernel.ValueObjects.Money", "UnitCost", b2 =>
                                {
                                    b2.Property<Guid>("SalesOrderLineId")
                                        .HasColumnType("uuid")
                                        .HasColumnName("id");
                            ...
                            b1.Navigation("InvoicedQuantity")
                                .IsRequired();

                            b1.Navigation("Quantity")
                                .IsRequired();

                            b1.Navigation("ReturnedQuantity")
                                .IsRequired();
            ...
            modelBuilder.Entity("AutoPartsErp.Modules.Sales.Domain.Returns.CustomerReturn", b =>
                {
                    b.OwnsMany("AutoPartsErp.Modules.Sales.Domain.Returns.CustomerReturnLine", "Lines", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.Property<Guid>("customer_return_id")
                                .HasColumnType("uuid")
                            ...
                            b1.HasIndex("customer_return_id")
                                .HasDatabaseName("ix_customer_return_lines_customer_return_id");

                            b1.HasIndex("TenantId", "SalesOrderLineId")
                                .HasDatabaseName("ix_customer_return_lines_tenant_order_line");

                            b1.ToTable("customer_return_lines", "sales");

                            b1.WithOwner()
                                .HasForeignKey("customer_return_id")
                                .HasConstraintName("fk_customer_return_lines_customer_returns_customer_return_id");

                            b1.OwnsOne("AutoPartsErp.SharedKernel.ValueObjects.Quantity", "Quantity", b2 =>
                                {
                                    b2.Property<Guid>("CustomerReturnLineId")
                                        .HasColumnType("uuid")
                                        .HasColumnName("id");
                                    ...
                                    b2.HasKey("CustomerReturnLineId");

                                    b2.ToTable("customer_return_lines", "sales");

                                    b2.WithOwner()
                                        .HasForeignKey("CustomerReturnLineId")
                                        .HasConstraintName("fk_customer_return_lines_customer_return_lines_id");
                                });
